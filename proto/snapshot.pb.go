...
func (x *SnapshotRequest) GetContainerId() string {
	if x != nil {
...
func (x *SnapshotReply) GetContainerId() string {
	if x != nil {
		return x.ContainerId
	}
	return ""
...
func (x *SnapshotReply) GetStatusId() int32 {
	if x != nil {
		return x.StatusId
	}
	return 0
...
var file_proto_snapshot_proto_rawDesc = []byte{
	...
	0x0c, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x22, 0x4f, 0x0a, 0x0d, 0x53, 0x6e, 0x61, 0x70, 0x73,
	0x68, 0x6f, 0x74, 0x52, 0x65, 0x70, 0x6c, 0x79, 0x12, 0x21, 0x0a, 0x0c, 0x63, 0x6f, 0x6e, 0x74,
	0x61, 0x69, 0x6e, 0x65, 0x72, 0x5f, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0b,
	0x63, 0x6f, 0x6e, 0x74, 0x61, 0x69, 0x6e, 0x65, 0x72, 0x49, 0x64, 0x12, 0x1b, 0x0a, 0x09, 0x73,
	0x74, 0x61, 0x74, 0x75, 0x73, 0x5f, 0x69, 0x64, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x49, 0x64, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72,
...
var file_proto_snapshot_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_proto_snapshot_proto_goTypes = []interface{}{
	(*SnapshotRequest)(nil), // 0: proto.SnapshotRequest
	(*SnapshotReply)(nil),   // 1: proto.SnapshotReply
}
